---
title: "H&M Customer Age Analysis"
...
```{r}
mature_transactions <- read.csv('/Users/rochellerafn/RStudio_Files/h-and-m-personalized-fashion-recommendations/mature_transactions')
young_transactions <- read.csv('/Users/rochellerafn/RStudio_Files/h-and-m-personalized-fashion-recommendations/young_transactions')
...
![](2022 - MSDS Capstone Update - K.007.jpeg)
...
### Mature Unique Items
![](MATURE_unique_items.jpg)

### Young Unique Items
![](YOUNG_unique_items.jpg)
...
![](2022 - MSDS Capstone Update - K.014.jpeg)
...
![](2022 - MSDS Capstone Update - K.015.jpeg)
...
```{r}
all_graphic_pct <- read.csv('/Users/rochellerafn/RStudio_Files/h-and-m-personalized-fashion-recommendations/all_graphic_pct')
...
head(all_graphic_pct) %>%
 gt() %>%
  tab_header(title = "Graphical Appearance",
...
![](2022 - MSDS Capstone Graph GIF.gif)
...
![](2022 - MSDS Capstone Update - K.017.jpeg)
