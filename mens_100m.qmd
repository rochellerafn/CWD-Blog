...
medal_content <- paste(sep = "<br/>",
  "Nation:", mens_100m_nation_medals$Nation,
  "<b>Rank:", mens_100m_nation_medals$Rank,
  "<b>Time:", mens_100m_nation_medals$Time
)

medal_label <- mens_100m_nation_medals %>%
  select(Nation, Rank, Time, lat, lon)
