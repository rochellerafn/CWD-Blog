...
```{r}
medal_icon <- iconList(
  medal = makeIcon("/Users/rochellerafn/RStudio_Files/medal.png", "medal@2x.png", 18, 18))
```
...
medal_color <- colorFactor(c("#EBD739", "#B5BCC2", "#FFB48C"), domain = c("Gold", "Silver", "Bronze"))
...
addMarkers(label = mens_100m_nation_medals$Rank,
