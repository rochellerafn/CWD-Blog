...
archive_mix_2017_ALL$Total <- as.numeric(gsub('[$]', '', archive_mix_2017_ALL$Total))
archive_mix_2017_ALL$Gross.Revenue <- as.numeric(gsub('[$]', '', archive_mix_2017_ALL$Gross.Revenue))
archive_mix_2017_ALL$Discounts <- as.numeric(gsub('[$]', '', archive_mix_2017_ALL$Discounts))
archive_mix_2017_ALL$Refund <- as.numeric(gsub('[$]', '', archive_mix_2017_ALL$Refund))
archive_mix_2017_ALL$Net.Revenue <- as.numeric(gsub('[$]', '', archive_mix_2017_ALL$Net.Revenue))
archive_mix_2017_ALL$Cost <- as.numeric(gsub('[$]', '', archive_mix_2017_ALL$Cost))
archive_mix_2017_ALL$Profitability <- as.numeric(gsub('[$]', '', archive_mix_2017_ALL$Profitability))
archive_mix_2017_ALL$Total <- as.numeric(gsub('[$]', '', archive_mix_2017_ALL$Total))
archive_mix_2017_ALL$Year <- as.character(archive_mix_2017_ALL$Year)
...
archive_mix_2018_ALL$Total <- as.numeric(gsub('[$]', '', archive_mix_2018_ALL$Total))
archive_mix_2018_ALL$Gross.Revenue <- as.numeric(gsub('[$]', '', archive_mix_2018_ALL$Gross.Revenue))
archive_mix_2018_ALL$Discounts <- as.numeric(gsub('[$]', '', archive_mix_2018_ALL$Discounts))
archive_mix_2018_ALL$Refund <- as.numeric(gsub('[$]', '', archive_mix_2018_ALL$Refund))
archive_mix_2018_ALL$Net.Revenue <- as.numeric(gsub('[$]', '', archive_mix_2018_ALL$Net.Revenue))
archive_mix_2018_ALL$Cost <- as.numeric(gsub('[$]', '', archive_mix_2018_ALL$Cost))
archive_mix_2018_ALL$Profitability <- as.numeric(gsub('[$]', '', archive_mix_2018_ALL$Profitability))
archive_mix_2018_ALL$Total <- as.numeric(gsub('[$]', '', archive_mix_2018_ALL$Total))
...
archive_mix_2019_ALL$Total <- as.numeric(gsub('[$]', '', archive_mix_2019_ALL$Total))
archive_mix_2019_ALL$Gross.Revenue <- as.numeric(gsub('[$]', '', archive_mix_2019_ALL$Gross.Revenue))
archive_mix_2019_ALL$Discounts <- as.numeric(gsub('[$]', '', archive_mix_2019_ALL$Discounts))
archive_mix_2019_ALL$Refund <- as.numeric(gsub('[$]', '', archive_mix_2019_ALL$Refund))
archive_mix_2019_ALL$Net.Revenue <- as.numeric(gsub('[$]', '', archive_mix_2019_ALL$Net.Revenue))
archive_mix_2019_ALL$Cost <- as.numeric(gsub('[$]', '', archive_mix_2019_ALL$Cost))
archive_mix_2019_ALL$Profitability <- as.numeric(gsub('[$]', '', archive_mix_2019_ALL$Profitability))
archive_mix_2019_ALL$Total <- as.numeric(gsub('[$]', '', archive_mix_2019_ALL$Total))
